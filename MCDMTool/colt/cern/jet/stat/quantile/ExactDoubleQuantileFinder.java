...
class ExactDoubleQuantileFinder extends cern.colt.PersistentObject implements
		DoubleQuantileFinder {
	 ...
	 */
	public Object clone() {
		ExactDoubleQuantileFinder copy = (ExactDoubleQuantileFinder) super
				.clone();
		if (this.buffer != null)
	...
	public double phi(double element) {
		this.sort();
		return cern.jet.stat.Descriptive.rankInterpolated(buffer, element)
				/ this.size();
	}
