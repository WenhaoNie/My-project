...
/**
 * A class to test the QuantileBin1D code. The command line is
 * "java Quantile1Test numExamples N" where numExamples is the number of random
...
public class Quantile1Test {
	public static void main(String[] argv) {
		...
		QuantileBin1D qAccum = new QuantileBin1D(false, N, 1.e-4, 1.e-3, 200,
				rand, false, false, 2);
