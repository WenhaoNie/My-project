 ...
 * {@link Functions} except operating on integers.
 * <p>
...
public class IntFunctions extends Object {
	 ...
	 */
	public static IntFunction bindArg1(final IntIntFunction function,
			final int c) {
		return new IntFunction() {
	 ...
	 */
	public static IntFunction bindArg2(final IntIntFunction function,
			final int c) {
		return new IntFunction() {
			public final int apply(int var) {
	 ...
	 */
	public static IntIntFunction chain(final IntFunction g,
			final IntIntFunction h) {
	 ...
	 */
	public static IntIntFunction chain(final IntIntFunction f,
			final IntFunction g, final IntFunction h) {
		return new IntIntFunction() {
			public final int apply(int a, int b) {
	 ...
	 * engine is {@link cern.jet.random.engine.MersenneTwister} and is seeded
