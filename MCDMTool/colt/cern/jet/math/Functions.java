 ...
 * for call-backs.
 * <p>
 * Unary functions are of type {@link cern.colt.function.DoubleFunction}, binary
 * functions of type {@link cern.colt.function.DoubleDoubleFunction}. All can be
 * retrieved via <tt>public 
  static final</tt> variables named after the function. Unary
 * predicates are of type {@link cern.colt.function.DoubleProcedure}, binary
 * predicates of type {@link cern.colt.function.DoubleDoubleProcedure}. All can
 * be retrieved via <tt>public 
...
public class Functions extends Object {
	 ...
	 */
	public static DoubleFunction bindArg1(final DoubleDoubleFunction function,
			final double c) {
		return new DoubleFunction() {
	 ...
	 */
	public static DoubleFunction bindArg2(final DoubleDoubleFunction function,
			final double c) {
		return new DoubleFunction() {
			public final double apply(double var) {
	 ...
	 */
	public static DoubleDoubleFunction chain(final DoubleDoubleFunction f,
			final DoubleFunction g, final DoubleFunction h) {
	 ...
	 */
	public static DoubleDoubleFunction chain(final DoubleFunction g,
			final DoubleDoubleFunction h) {
		return new DoubleDoubleFunction() {
			public final double apply(double a, double b) {
	 ...
	 */
	public static DoubleFunction chain(final DoubleFunction g,
	...
	public static void demo1() {
		...
		double v = Math.sin(a) + Math.pow(Math.cos(b), 2);
		System.out.println(v);
		DoubleDoubleFunction f = F.chain(F.plus, F.sin,
				F.chain(F.square, F.cos));
	...
	public static void demo2(int size) {
		...
		DoubleDoubleFunction f = F.chain(F.abs,
		...
		timer.stop().display();
		System.out.println("evals / sec = " + size
				/ timer.minus(emptyLoop).seconds());
	 ...
	 * {@link cern.jet.random.engine.RandomEngine} and any random distribution
	 * derived from {@link cern.jet.random.AbstractDistribution} are function
