...
public class RandomSamplingAssistant extends cern.colt.PersistentObject {
	...
	public static int[] sampleArray(int n, int[] elements) {
		RandomSamplingAssistant assistant = new RandomSamplingAssistant(n,
	...
	public static void test(long n, long N) {
		RandomSamplingAssistant assistant = new RandomSamplingAssistant(n, N,
				null);

		cern.colt.list.LongArrayList sample = new cern.colt.list.LongArrayList(
				(int) n);
