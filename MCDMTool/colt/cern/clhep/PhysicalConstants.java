 ...
 * the <a href=
 * "http://wwwinfo.cern.ch/asd/lhc++/clhep/manual/RefGuide/Units/PhysicalConstants_h.html"
...
public class PhysicalConstants extends Object {
	...
	public static final double classic_electr_radius = elm_coupling
			/ electron_mass_c2;
	public static final double electron_Compton_length = hbarc
			/ electron_mass_c2;
	public static final double Bohr_radius = electron_Compton_length
	...
	//
	//
	public static final double k_Boltzmann = 8.617385e-11 * Units.MeV
			/ Units.kelvin;
	...
	//
	//
	public static final double universe_mean_density = 1.e-25 * Units.g
			/ Units.cm3;
