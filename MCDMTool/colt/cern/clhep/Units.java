 ...
 * the <a href=
 * "http://wwwinfo.cern.ch/asd/lhc++/clhep/manual/RefGuide/Units/SystemOfUnits_h.html"
...
public class Units {
	...
	public static final double millimeter3 = millimeter * millimeter
			* millimeter;

	public static final double centimeter = 10. * millimeter;
	public static final double centimeter2 = centimeter * centimeter;
	public static final double centimeter3 = centimeter * centimeter
			* centimeter;
	...
	public static final double e_SI = 1.60217733e-19; // positron charge in
														// coulomb
	public static final double coulomb = eplus / e_SI; // coulomb = 6.24150 e+18
														// * eplus
	...
	// Mass [E][T^2][L^-2]
	//
	public static final double kilogram = joule * second * second
			/ (meter * meter);
	...
	// Pressure [E][L^-3]
	//
	public static final double hep_pascal = newton / m2; // pascal = 6.24150 e+3
															// * MeV/mm3
