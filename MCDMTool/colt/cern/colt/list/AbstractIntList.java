 ...
 * picture.
 */
public abstract class AbstractIntList extends AbstractList implements
	 ...
	 *                <tt>index &lt; 0 || index &gt; size()</tt>).
	 */
	public void beforeInsertAllOfFromTo(int index, AbstractIntList other,
			int from, int to) {
	...
	public void replaceFromToWithFromTo(int from, int to,
			AbstractIntList other, int otherFrom, int otherTo) {
