...
public abstract class DoubleMatrix2D extends AbstractMatrix2D {
	 ...
	 * @return a new view.
	 */
	protected abstract DoubleMatrix2D viewSelectionLike(int[] rowOffsets,
			int[] columnOffsets);
	 ...
	 * {@link cern.colt.matrix.doublealgo.Sorting#sort(DoubleMatrix2D,int)}. For
	...
	public void zAssign8Neighbors(DoubleMatrix2D B,
		...
		for (int i = 1; i < r; i++) {
			...
			for (int j = 1; j < c; j++) {
				...
				B.setQuick(i, j, function.apply(a00, a01, a02, a10, a11, a12,
						a20, a21, a22));
