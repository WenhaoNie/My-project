...
public class ObjectFactory2D extends cern.colt.PersistentObject {
	 ...
	 * 
	 * <pre>
	 * ObjectMatrix2D[][] parts1 = { { null, make(2, 2, 1), null },
	 ...
	 * 
	 * <pre>
	 * ObjectMatrix2D[][] parts3 = { { identity(3), null, },
	 ...
	 * 
	 * <pre>
	 * ObjectMatrix2D[][] parts2 = { { null, make(2, 2, 1), null },
	...
	public ObjectMatrix2D composeDiagonal(ObjectMatrix2D A, ObjectMatrix2D B,
			ObjectMatrix2D C) {
		ObjectMatrix2D diag = make(A.rows() + B.rows() + C.rows(), A.columns()
				+ B.columns() + C.columns());
	 ...
	 * </pre>
	 */
	public ObjectMatrix2D repeat(ObjectMatrix2D A, int rowRepeat,
			int columnRepeat) {
		int r = A.rows();
		int c = A.columns();
