...
public class Partitioning extends Object {
	 ...
	 */
	public static void partition(ObjectMatrix2D matrix, int[] rowIndexes,
			int rowFrom, int rowTo, int column, final Object[] splitters,
	 ...
	 *         splitters.
	 */
	public static ObjectMatrix2D partition(ObjectMatrix2D matrix, int column,
			final Object[] splitters, int[] splitIndexes) {
		int rowFrom = 0;
	 ...
	 * </table>
	 */
	private static void xPartitionOld(ObjectMatrix2D matrix,
			ObjectMatrix1D column, int from, int to, Object[] splitters,
			int splitFrom, int splitTo, int[] splitIndexes) {
		/*
	 ...
	 * Note that arguments are not checked for validity.
	 */
	private static int xPartitionOld(ObjectMatrix2D matrix,
			ObjectMatrix1D column, int from, int to, Object splitter) {
		/*
