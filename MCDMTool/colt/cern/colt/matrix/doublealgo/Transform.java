 ...
 * {@link cern.colt.matrix.DoubleMatrix2D}. All transformations modify the first
 * argument matrix to hold the result of the transformation. Use idioms like
 * <tt>result = mult(matrix.copy(),5)</tt> to leave source matrices unaffected.
 * <p>
 ...
 * objects of {@link cern.jet.math.Functions}, using idioms like
 * <table>
 * <td class="PRE">
 * 
 * <pre>
...
public class Transform extends cern.colt.PersistentObject {
	 ...
	 * @return <tt>A</tt> (for convenience only).
	 */
	public static DoubleMatrix1D minusMult(DoubleMatrix1D A, DoubleMatrix1D B,
			double s) {
	 ...
	 * @return <tt>A</tt> (for convenience only).
	 */
	public static DoubleMatrix2D minusMult(DoubleMatrix2D A, DoubleMatrix2D B,
			double s) {
		return A.assign(B, F.minusMult(s));
	}
	 ...
	 * @return <tt>A</tt> (for convenience only).
	 */
	public static DoubleMatrix1D plusMult(DoubleMatrix1D A, DoubleMatrix1D B,
			double s) {
	 ...
	 * @return <tt>A</tt> (for convenience only).
	 */
	public static DoubleMatrix2D plusMult(DoubleMatrix2D A, DoubleMatrix2D B,
			double s) {
		return A.assign(B, F.plusMult(s));
	}
