 ...
 * <tt>A = L*L'</tt>; If the matrix is not symmetric or positive definite, the
 * constructor returns a partial decomposition and sets an internal flag that
...
public class CholeskyDecomposition implements java.io.Serializable {
	 ...
	 * @return Structure to access <tt>L</tt> and
	 *         <tt>isSymmetricPositiveDefinite</tt> flag.
	...
	public String toString() {
		...
		buf.append("\n\ninverse(A) = ");
		try {
			buf.append(String.valueOf(this
					.solve(cern.colt.matrix.DoubleFactory2D.dense.identity(L
							.rows()))));
		} catch (IllegalArgumentException exc) {
			buf.append(unknown + exc.getMessage());
		}
