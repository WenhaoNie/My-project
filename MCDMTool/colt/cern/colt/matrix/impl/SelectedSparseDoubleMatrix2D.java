...
class SelectedSparseDoubleMatrix2D extends DoubleMatrix2D {
	 ...
	 * @param offset
	 */
	protected SelectedSparseDoubleMatrix2D(int rows, int columns,
			AbstractIntDoubleMap elements, int rowZero, int columnZero,
			int rowStride, int columnStride, int[] rowOffsets,
	 ...
	 * @param offset
	 */
	protected SelectedSparseDoubleMatrix2D(AbstractIntDoubleMap elements,
	...
	public void setQuick(int row, int column, double value) {
		...
		// manually inlined:
		int index = offset + rowOffsets[rowZero + row * rowStride]
				+ columnOffsets[columnZero + column * columnStride];
	...
	public DoubleMatrix1D viewColumn(int column) {
		...
		return new SelectedSparseDoubleMatrix1D(viewSize, this.elements,
