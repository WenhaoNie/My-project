...
class SelectedSparseDoubleMatrix1D extends DoubleMatrix1D {
	 ...
	 * @param offset
	 */
	protected SelectedSparseDoubleMatrix1D(int size,
			AbstractIntDoubleMap elements, int zero, int stride, int[] offsets,
			int offset) {
	 ...
	 */
	protected SelectedSparseDoubleMatrix1D(AbstractIntDoubleMap elements,
			int[] offsets) {
