...
class SelectedDenseObjectMatrix2D extends ObjectMatrix2D {
	 ...
	 * @param offset
	 */
	protected SelectedDenseObjectMatrix2D(Object[] elements, int[] rowOffsets,
			int[] columnOffsets, int offset) {
		this(rowOffsets.length, columnOffsets.length, elements, 0, 0, 1, 1,
				rowOffsets, columnOffsets, offset);
	}
	 ...
	 * @param offset
	 */
	protected SelectedDenseObjectMatrix2D(int rows, int columns,
			Object[] elements, int rowZero, int columnZero, int rowStride,
			int columnStride, int[] rowOffsets, int[] columnOffsets, int offset) {
	...
	protected int index(int row, int column) {
		...
		// manually inlined:
		return this.offset + rowOffsets[rowZero + row * rowStride]
				+ columnOffsets[columnZero + column * columnStride];
	}
	...
	public void setQuick(int row, int column, Object value) {
		...
		// manually inlined:
		elements[offset + rowOffsets[rowZero + row * rowStride]
	...
	public ObjectMatrix1D viewColumn(int column) {
		...
		return new SelectedDenseObjectMatrix1D(viewSize, this.elements,
	...
	protected ObjectMatrix2D viewSelectionLike(int[] rowOffsets,
			int[] columnOffsets) {
		return new SelectedDenseObjectMatrix2D(this.elements, rowOffsets,
				columnOffsets, this.offset);
	}
}
