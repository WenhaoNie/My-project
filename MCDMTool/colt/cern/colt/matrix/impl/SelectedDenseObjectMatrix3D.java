...
class SelectedDenseObjectMatrix3D extends ObjectMatrix3D {
	 ...
	 */
	protected SelectedDenseObjectMatrix3D(Object[] elements,
	...
	public Object getQuick(int slice, int row, int column) {
		...
		// manually inlined:
		return elements[offset + sliceOffsets[sliceZero + slice * sliceStride]
	...
	public ObjectMatrix2D viewColumn(int column) {
		...
		return new SelectedDenseObjectMatrix2D(viewRows, viewColumns,
