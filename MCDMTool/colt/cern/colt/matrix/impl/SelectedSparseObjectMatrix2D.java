...
class SelectedSparseObjectMatrix2D extends ObjectMatrix2D {
	...
	protected SelectedSparseObjectMatrix2D(int rows, int columns,
			AbstractIntObjectMap elements, int rowZero, int columnZero,
	 ...
	 * @param offset
	 */
	protected SelectedSparseObjectMatrix2D(AbstractIntObjectMap elements,
	...
	public ObjectMatrix1D viewColumn(int column) {
		...
		return new SelectedSparseObjectMatrix1D(viewSize, this.elements,
	...
	protected ObjectMatrix2D viewSelectionLike(int[] rowOffsets,
			int[] columnOffsets) {
		return new SelectedSparseObjectMatrix2D(this.elements, rowOffsets,
