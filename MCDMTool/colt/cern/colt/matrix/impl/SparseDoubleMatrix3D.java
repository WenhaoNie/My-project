 ...
 * {@link cern.colt.map.OpenIntDoubleHashMap}, which is a compact and performant
 * hashing technique.
 * <p>
...
public class SparseDoubleMatrix3D extends DoubleMatrix3D {
	...
	public SparseDoubleMatrix3D(int slices, int rows, int columns,
		...
		this.elements = new OpenIntDoubleHashMap(initialCapacity,
	 ...
	 *             if <tt>slices<0 || rows<0 || columns<0</tt>.
	 */
	protected SparseDoubleMatrix3D(int slices, int rows, int columns,
			AbstractIntDoubleMap elements, int sliceZero, int rowZero,
	...
	public double getQuick(int slice, int row, int column) {
		...
		// manually inlined:
		return elements.get(sliceZero + slice * sliceStride + rowZero + row
	...
	protected DoubleMatrix2D like2D(int rows, int columns, int rowZero,
		...
		return new SparseDoubleMatrix2D(rows, columns, this.elements, rowZero,
	...
	public void setQuick(int slice, int row, int column, double value) {
		...
		// manually inlined:
		int index = sliceZero + slice * sliceStride + rowZero + row * rowStride
				+ columnZero + column * columnStride;
		if (value == 0)
	...
	protected DoubleMatrix3D viewSelectionLike(int[] sliceOffsets,
		...
		return new SelectedSparseDoubleMatrix3D(this.elements, sliceOffsets,
