...
public class SparseObjectMatrix3D extends ObjectMatrix3D {
	...
	public SparseObjectMatrix3D(int slices, int rows, int columns,
		...
		this.elements = new OpenIntObjectHashMap(initialCapacity,
	 ...
	 *             if <tt>slices<0 || rows<0 || columns<0</tt>.
	 */
	protected SparseObjectMatrix3D(int slices, int rows, int columns,
			AbstractIntObjectMap elements, int sliceZero, int rowZero,
	 ...
	 */
	protected ObjectMatrix2D like2D(int rows, int columns, int rowZero,
			int columnZero, int rowStride, int columnStride) {
		return new SparseObjectMatrix2D(rows, columns, this.elements, rowZero,
	 ...
	 * @return a new view.
	 */
	protected ObjectMatrix3D viewSelectionLike(int[] sliceOffsets,
			int[] rowOffsets, int[] columnOffsets) {
		return new SelectedSparseObjectMatrix3D(this.elements, sliceOffsets,
