...
public class DenseObjectMatrix3D extends ObjectMatrix3D {
	 ...
	 *             if <tt>slices<0 || rows<0 || columns<0</tt>.
	 */
	protected DenseObjectMatrix3D(int slices, int rows, int columns,
			Object[] elements, int sliceZero, int rowZero, int columnZero,
	...
	protected ObjectMatrix2D like2D(int rows, int columns, int rowZero,
		...
		return new DenseObjectMatrix2D(rows, columns, this.elements, rowZero,
	...
	protected ObjectMatrix3D viewSelectionLike(int[] sliceOffsets,
		...
		return new SelectedDenseObjectMatrix3D(this.elements, sliceOffsets,
