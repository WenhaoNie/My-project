...
class SelectedSparseObjectMatrix3D extends ObjectMatrix3D {
	 ...
	 */
	protected SelectedSparseObjectMatrix3D(AbstractIntObjectMap elements,
	...
	protected int index(int slice, int row, int column) {
		...
		// manually inlined:
		return this.offset + sliceOffsets[sliceZero + slice * sliceStride]
				+ rowOffsets[rowZero + row * rowStride]
				+ columnOffsets[columnZero + column * columnStride];
	}
	...
	public void setQuick(int slice, int row, int column, Object value) {
		...
		// manually inlined:
		int index = offset + sliceOffsets[sliceZero + slice * sliceStride]
				+ rowOffsets[rowZero + row * rowStride]
				+ columnOffsets[columnZero + column * columnStride];
		if (value == null)
	...
	public ObjectMatrix2D viewColumn(int column) {
		...
		return new SelectedSparseObjectMatrix2D(viewRows, viewColumns,
				this.elements, viewRowZero, viewColumnZero, viewRowStride,
	...
	protected ObjectMatrix3D viewSelectionLike(int[] sliceOffsets,
		...
		return new SelectedSparseObjectMatrix3D(this.elements, sliceOffsets,
				rowOffsets, columnOffsets, this.offset);
	}
