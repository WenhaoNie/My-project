...
class SelectedDenseDoubleMatrix2D extends DoubleMatrix2D {
	 ...
	 * @param offset
	 */
	protected SelectedDenseDoubleMatrix2D(double[] elements, int[] rowOffsets,
	 ...
	 * @param offset
	 */
	protected SelectedDenseDoubleMatrix2D(int rows, int columns,
	...
	public DoubleMatrix1D viewColumn(int column) {
		...
		return new SelectedDenseDoubleMatrix1D(viewSize, this.elements,
