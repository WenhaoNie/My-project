...
public abstract class AbstractDoubleIntMap extends AbstractMap {
	...
	public void pairsMatching(final DoubleIntProcedure condition,
			final DoubleArrayList keyList, final IntArrayList valueList) {
		keyList.clear();
		valueList.clear();
	 ...
	 *            the list to be filled with values, can have any size.
	 */
	public void pairsSortedByKey(final DoubleArrayList keyList,
	 ...
	 *            the list to be filled with values, can have any size.
	 */
	public void pairsSortedByValue(final DoubleArrayList keyList,
			final IntArrayList valueList) {
		keys(keyList);
		values(valueList);
