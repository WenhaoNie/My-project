...
public abstract class AbstractIntObjectMap extends AbstractMap {
	 ...
	 */
	public void pairsMatching(final IntObjectProcedure condition,
			final IntArrayList keyList, final ObjectArrayList valueList) {
		keyList.clear();
		valueList.clear();
	 ...
	 *            the list to be filled with values, can have any size.
	 */
	public void pairsSortedByKey(final IntArrayList keyList,
	 ...
	 *            the list to be filled with values, can have any size.
	 */
	public void pairsSortedByValue(final IntArrayList keyList,
			final ObjectArrayList valueList) {
		keys(keyList);
		values(valueList);
