...
abstract class AbstractHistogram2D extends Histogram implements IHistogram2D {
	 ...
	 */
	protected abstract IHistogram1D internalSliceX(String title, int indexY1,
			int indexY2);
	 ...
	 * flow bins <b>Note 3</b>There is no note 3 (yet)
	 */
	protected abstract IHistogram1D internalSliceY(String title, int indexX1,
			int indexX2);
	...
	public IHistogram1D projectionX() {
		...
		return internalSliceX(newTitle, mapY(IHistogram.UNDERFLOW),
	...
	public IHistogram1D projectionY() {
		...
		return internalSliceY(newTitle, mapX(IHistogram.UNDERFLOW),
